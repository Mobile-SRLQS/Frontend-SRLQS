 ...
 * Use the [HelpSeekingQuestionFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class HelpSeekingQuestionFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment HelpSeekingQuestionFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            HelpSeekingQuestionFragment().apply {
