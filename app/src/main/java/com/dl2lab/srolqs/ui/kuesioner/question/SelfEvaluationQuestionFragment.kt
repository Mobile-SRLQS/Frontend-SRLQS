 ...
 * Use the [SelfEvaluationQuestionFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class SelfEvaluationQuestionFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SelfEvaluationQuestionFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SelfEvaluationQuestionFragment().apply {
